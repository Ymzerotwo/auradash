/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5b7dde51d76cff0f0df60c1a0eb6d184)
// Runtime types generated with workerd@1.20260801.1 2026-04-28 nodejs_compat
interface __BaseEnv_Env {
	...
	DASHBOARD_LIMITER: RateLimit;
	LOGIN_RECOVERY_LIMITER: RateLimit;
	VERIFY_CODE_LIMITER: RateLimit;
	STATE_LIMITER: RateLimit;
	NOTIFICATIONS_LIMITER: RateLimit;
	PUBLIC_SUBMISSION_LIMITER: RateLimit;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_API_TOKEN" | "AURADASH_MASTER_SECRET" | "CF_ACCOUNT_ID" | "R2_PUBLIC_URL" | "ALLOWED_ORIGINS" | "EMAIL_FROM_ADDRESS" | "APP_FRONTEND_URL">> {}
}
