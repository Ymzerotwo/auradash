      ...
      <div className="relative w-full">
        <div className="relative w-full">
          {Icon && (
            <span
              className={cn(
                "absolute top-1/2 -translate-y-1/2 text-muted-foreground pointer-events-none flex items-center justify-center z-10",
                isLtr ? "left-4" : isRtl ? "right-4" : "start-4"
              )}
            >
              <Icon size={18} />
            </span>
          ...
          <input
            ...
            className={cn(
              ...
              Icon && (isLtr ? "!pl-11" : isRtl ? "!pr-11" : "ps-11"),
              endAdornment && (isLtr ? "!pr-11" : isRtl ? "!pl-11" : "pe-11"),
          ...
          {endAdornment && (
            <span
              className={cn(
                ...
                isLtr ? "right-4" : isRtl ? "left-4" : "end-4"
              )}
            >
              {endAdornment}
            </span>
